...
<form id="form1" name="form1" method="post" action="unselect.action">
  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4">
    <tr>
      ...
      <td width="79%" bgcolor="#FFFFFF"><fieldset>
         <s:property value='subject.subname'/>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><fieldset>
          <s:property value='subject.teacher.teaname'/>
        </fieldset></td>
    </tr>
    <tr>
      <td height="25" align="right" bgcolor="#D6F2FD">简介要求：&nbsp;</td>
      <td bgcolor="#FFFFFF"><fieldset>
            <s:property value='subject.subcontent'/>
        </fieldset></td>
    </tr>
    <tr>
      <td height="25" align="right" bgcolor="#D6F2FD">截止日期：&nbsp;</td>
      <td bgcolor="#FFFFFF"><fieldset>
           <s:property value='subject.endtime'/>
        </fieldset></td>
    </tr>
    <tr>
